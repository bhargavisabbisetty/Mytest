    ...
    public AdminCreateScreen(JPanel panelRight, Admin admin) {
     ...
     public boolean validateEmail(){
       ...
       Pattern pattern = Pattern.compile(emailPattern);
        ...
        Matcher match = pattern.matcher(txtUser.getText());
...
return match.matches();
     ...
     {
       String passwordPattern = "^[A-Za-z0-9_$]{6,12}";
        Pattern pattern = Pattern.compile(passwordPattern);
        Matcher match = pattern.matcher(txtPword.getText());
        return match.matches();
     }
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
       ...
       {
           JOptionPane.showMessageDialog(null, "Invalid Entry Email");
       }
         if(!(validatePassword()==true))
       {
           JOptionPane.showMessageDialog(null, "Inavalid Entry Password");
       }
        
         String S1 = txtRePword.getText();
     ...
     if(buttonGroup.isSelected(radioCustomer.getModel()))
       {
           Customer customer = new Customer(txtPword.getText(),txtUser.getText(), "CUSTOMER");
           admin.customerDirectory.getCustomerList().add(customer);
           JOptionPane.showMessageDialog(null, "Added Customer");
           
       }
       else if(buttonGroup.isSelected(radioSupplier.getModel()))
       {
           Supplier supplier = new Supplier(txtPword.getText(),txtUser.getText(), "SUPPLIER");
           admin.supplierDirectory.getSupplierList().add(supplier);
